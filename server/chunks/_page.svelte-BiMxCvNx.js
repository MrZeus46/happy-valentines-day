import { P as attr_class, Q as attr_style, T as attributes, V as clsx, X as bind_props, Y as clsx$1, Z as stringify, _ as ensure_array_like, O as attr } from './index-CnWM5vWj.js';
import './context-CKR25gbz.js';
...
function _page($$renderer) {
  ...
  if (celebrate) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<div class="fixed inset-0 z-50 pointer-events-none overflow-hidden bg-black/30 svelte-1uha8ag"><!--[-->`);
    const each_array = ensure_array_like(Array(30));
    for (let i = 0, $$length = each_array.length; i < $$length; i++) {
      each_array[i];
      $$renderer.push(`<span class="confetti svelte-1uha8ag"${attr_style(` left: ${stringify(Math.random() * 100)}%; animation-delay: ${stringify(Math.random())}s; background: hsl(${stringify(Math.random() * 360)}, 80%, 60%); `)}></span>`);
    }
    $$renderer.push(`<!--]--> <!--[-->`);
    const each_array_1 = ensure_array_like(Array(20));
    for (let i = 0, $$length = each_array_1.length; i < $$length; i++) {
      each_array_1[i];
      $$renderer.push(`<span class="heart svelte-1uha8ag"${attr_style(` left: ${stringify(Math.random() * 100)}%; animation-delay: ${stringify(Math.random())}s; `)}>❤️</span>`);
    }
    $$renderer.push(`<!--]--> <div class="celebrate-text svelte-1uha8ag">Yay! It's a Date 💖</div> `);
    if (showImage) {
      $$renderer.push("<!--[-->");
      $$renderer.push(`<div class="celebration-image svelte-1uha8ag"><img${attr("src", celebrationImagePath)} alt="Celebration" class="w-full h-full object-contain svelte-1uha8ag"/></div> <div class="celebration-image1 svelte-1uha8ag"><img${attr("src", celebrationImagePath)} alt="Celebration" class="w-full h-full object-contain svelte-1uha8ag"/></div>`);
    } else {
      $$renderer.push("<!--[!-->");
    }
    $$renderer.push(`<!--]--></div>`);
  ...
  $$renderer.push(`<!--]--> <div class="h-screen flex items-center justify-center bg-linear-to-br from-pink-50 via-red-50 to-pink-100 bg-image svelte-1uha8ag">`);
  if (showCard) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<div${attr_class(`p-8 md:p-10 rounded-3xl bg-white/95 backdrop-blur-md shadow-2xl flex flex-col items-center gap-10 max-w-2xl w-full mx-4 transition-all duration-500 ease-out ${stringify(celebrate ? "scale-95 opacity-0" : "scale-100 opacity-100")}`, "svelte-1uha8ag")}><p class="text-3xl md:text-4xl font-bold text-center text-gray-800 svelte-1uha8ag">Will you be my Valentine? 🥺❤️</p> <div class="flex items-center justify-center gap-6 md:gap-10 w-full relative min-h-30 svelte-1uha8ag">`);
    Button($$renderer, {
      size: "lg",
      onclick: onYesClick,
      class: `text-lg md:text-xl px-10 md:px-14 py-7 md:py-8
                           ...
                           ${stringify(isScared ? "scale-110 ring-4 ring-pink-300/50" : "")}`,
      children: ($$renderer2) => {
        $$renderer2.push(`<!---->Yes!! 💕`);
      },
      $$slots: { default: true }
    });
    $$renderer.push(`<!----> <div class="relative w-fit h-fit svelte-1uha8ag"><div class="absolute inset-0 transition-transform ease-out svelte-1uha8ag"${attr_style(`transform:
  ...
  $$renderer.push(`<!--]--></div>  <audio preload="auto" class="svelte-1uha8ag"><source src="/sounds/success.mp3" class="svelte-1uha8ag"/></audio>`);
}

export { _page as default };
//# sourceMappingURL=_page.svelte-BiMxCvNx.js.map
